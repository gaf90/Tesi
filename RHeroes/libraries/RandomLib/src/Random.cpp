...
#define RANDOMLIB_RANDOM_CPP "$Id: 9640716b820d7498e5640deeed9a6f53c8c3a786 $"
...
#define SFMT19937_REVSTEP128(I, J, K, L) {              \
  ...
  template<class RandomType>
#ifdef __APPLE__ /* Mladen hack: OSX llvm gcc doesn't understand __m128i[] at link time */
  void SFMT19937<RandomType>::Transition(long long count,
                                         void *s)
    throw() {
    internal_type *statev = static_cast<internal_type *>(s);
#else
  void SFMT19937<RandomType>::Transition(long long count,
